...
namespace WebApiMahasiswa
{
    ...
    public class MahasiswaController : ControllerBase
    {
        ...
        {
            new Mahasiswa { Nama = "Ghifari", Nim = "1302220033" },
            new Mahasiswa { Nama = "Alan", Nim = "1302229070" },
            new Mahasiswa { Nama = "Aldino", Nim = "1302224344" },
            new Mahasiswa { Nama = "Harits", Nim = "1302222656" },
        };
